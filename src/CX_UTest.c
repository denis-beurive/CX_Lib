...
/**
 * @brief Set the absolute path to the project root directory.
...
/**
 * @brief Given an absolute path, the function returns the corresponding relative path, relatively
...
/**
 * @brief Set the relative path (relatively to the root path) to the current C file that is being tested.
...
/**
 * @brief Set the name of the current function being tested.
...
/**
 * @brief Set the absolute path to the directory used to store the reports generated by the "mcheck" library.
...
/**
 * @brief Set the index of the condition, within the current C file that is being tested, that must return TRUE no matter
 * the context.
...
/**
 * @brief Test whether the currently evaluated condition is the one expected to return TRUE no matter the context.
 ...
 * @note You should not call this function directly. Use `CX_UTEST_FORCE_TRUE()`.
 */
...
/**
 * @brief Return the absolute path to the file that contains the report generated by MCheck.
...
/**
 * @brief Return the environment configuration that will tell MCheck to store the report into a given
