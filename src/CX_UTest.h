...
#define CX_UTEST_INIT_ALL(inProjectRootAbsolutePath, inTestedSourceRelativePath, inMCheckReportAbsoluteDirectoryPath) \
    _CX_UTestSetRootPath(inProjectRootAbsolutePath); \
    _CX_UTestSetCurrentRelativePath(inTestedSourceRelativePath); \
    _CX_UTestSetMCheckReportPath(inMCheckReportAbsoluteDirectoryPath)
...
#ifdef CX_UTEST
#define CX_UTEST_FORCE_TRUE(id) || _CX_UTestIsCurrentCondition(__FILE__, __FUNCTION__, id)
#else
