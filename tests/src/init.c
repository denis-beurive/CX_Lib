...
char data_dir_path[TESTS_MAX_PATH_LENGTH];
char report_dir_path[TESTS_MAX_PATH_LENGTH];
static char malloc_trace_report_path[TESTS_MAX_PATH_LENGTH];
...
int SL_testsInit(void) {
    ...
    snprintf(data_dir_path, TESTS_MAX_PATH_LENGTH - 1, "%s/data", dir);
    data_dir_path[TESTS_MAX_PATH_LENGTH - 1] = 0;
    snprintf(report_dir_path, TESTS_MAX_PATH_LENGTH - 1, "%s/report", dir);
    report_dir_path[TESTS_MAX_PATH_LENGTH - 1] = 0;
    free(thisFile);
...
static char *getReportFilePath(char *inFileName) {
    snprintf(malloc_trace_report_path, TESTS_MAX_PATH_LENGTH, "%s/%s", report_dir_path, inFileName);
    malloc_trace_report_path[TESTS_MAX_PATH_LENGTH - 1] = 0;
